...
class EMRunner(object):
    ...
    def _get_em_guess_4gauss(self):
        ...
        pars=array( [_em4_pguess[0]*(1.0+0.1*srandu()),
                     ...
                     _em4_pguess[3]*(1.0+0.1*srandu()),
                     0.1*srandu(),
                     0.1*srandu(),
                     _em4_fguess[3]*sigma2*(1.0 + 0.1*srandu()),
                     0.01*srandu(),
                     _em4_fguess[3]*sigma2*(1.0 + 0.1*srandu())]
...
class MaxRunner(object):
    ...
    def __init__(self, obs, model, max_pars, guesser, prior=None,
        ...
        assert model in ['exp','dev','gauss','turb'],mess
...
_em4_pguess = array([0.6,0.3,0.095,0.005])
_em4_fguess = array([0.5793612389470884,1.0, 3.0, 10.0])
